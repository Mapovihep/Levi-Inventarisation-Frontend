    ...
    return(
        <ListItem>    
            <Card className="post_card">      
                    <CardContent onClick={handlerRoute} className="post_card_hovered_part">
                        ...
                        : <div className="post_info">
                            ...
                            <Typography className="post_author" variant="h6">
                                {(' user: ' + state.modelUserId.substr(30)||' your_post')}
                            </Typography>
                        </div>}
                        {state.editMode ? 
                        <textarea 
                    ...
                    {userId === state.modelUserId && <IconButton aria-label="delete" onClick={deletePost}>
                            <DeleteIcon />
                            <Dialog
                    ...
                    {userId === state.modelUserId&&<Button onClick={editMode}
